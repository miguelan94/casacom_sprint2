...
public class DMCategory extends DMElement implements IMenuPrintable
{
    ...
    public DMCategory(JSONObject o)
    {
        ...
        try
        {
            ...
            if(!o.isNull("docs")) this.docs = DMDocument.documentsWithArray(o.getJSONArray("docs"));
            if(!o.isNull("categories")) this.categories = DMCategory.categoriesWithArray(o.getJSONArray("categories"));
        }
